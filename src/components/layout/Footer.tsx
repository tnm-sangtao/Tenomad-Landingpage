          ...
          <div className="max-w-md">
            ...
            <div className="space-y-2 text-xs text-muted-foreground font-light tracking-wide">
              ...
              <p className="flex items-center gap-2">
                <span className="font-bold text-[14px] uppercase tracking-wider text-foreground shrink-0">Tel:</span>
                <span>(+84) 0234-6271-757</span>
              </p>
              <p className="flex items-center gap-2">
                <span className="font-bold text-[14px] uppercase tracking-wider text-foreground shrink-0">Email:</span>
